...
<div id="app">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top" id="topbar" v-show="$route.path=== '/' || $route.path=== '/register' || $route.path=== '/forget' ? false:true" style="display:none;">
   ...
   <div id="wrapper">
        ...
        <li class="nav-item dropdown">
            ...
            <router-link class="dropdown-item" to="/create/">Add Employee</router-link>
            <router-link class="dropdown-item" to="/index">All Employee</router-link>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-fw fa-folder"></i>
